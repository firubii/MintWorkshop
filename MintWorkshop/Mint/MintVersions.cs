        ...
        public static Dictionary<byte[], Opcode[]> Versions = new Dictionary<byte[], Opcode[]>(new ByteArrayComparer())
        {
            ...
            },
            {
                ...
                new Opcode[] {
                    ...
                    new Opcode("ldsr3",  new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    new Opcode("ldsr4",  new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    new Opcode("ldsr5",  new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("unk_10",    new InstructionArg[] {InstructionArg.RegZ}, Action.Return),
                    new Opcode("unk_11",    new InstructionArg[] {InstructionArg.RegY}, Action.Return),
                    ...
                    new Opcode("ctu32f", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("ctf32u", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("call",   new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("unk_6d",   new InstructionArg[] {InstructionArg.XRefV}),
                    Opcode.None(),
