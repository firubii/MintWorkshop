        ...
        public static Dictionary<byte[], Opcode[]> Versions = new Dictionary<byte[], Opcode[]>(new ByteArrayComparer())
        {
            ...
            },
            {
                ...
                new Opcode[] {
                    ...
                    new Opcode("unk_09",  new InstructionArg[] {InstructionArg.RegZ, InstructionArg.XRefV}),
                    new Opcode("ldsrzr",  new InstructionArg[] {InstructionArg.RegZ}),
                    new Opcode("ldsrc4",  new InstructionArg[] {InstructionArg.RegZ, InstructionArg.IntV}),
                    ...
                    new Opcode("jmppos", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}, Action.Jump),
                    new Opcode("jmpneg", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}, Action.Jump),
                    new Opcode("neiadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("nefadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("ltiadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("ltfadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("leiadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("lefadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("gtiadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("gtfadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("geiadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("gefadv", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("opldof",   new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("unk_52",   new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    Opcode.None(),
                    new Opcode("unk_54",   new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}), //5f
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("unk_6d",   new InstructionArg[] {InstructionArg.VSigned}),
                    Opcode.None(),
                    new Opcode("unk_6f",    new InstructionArg[] {InstructionArg.RegY}),
                    new Opcode("unk_70",    new InstructionArg[] {InstructionArg.Y}),
                    new Opcode("unk_71",    new InstructionArg[] {InstructionArg.X, InstructionArg.Y}),
                    new Opcode("yield",    new InstructionArg[] {InstructionArg.RegZ}),
                    Opcode.None()
                }
            }
