        ...
        public static Dictionary<byte[], Opcode[]> Versions = new Dictionary<byte[], Opcode[]>(new ByteArrayComparer())
        {
            ...
            },
            {
                ...
                new Opcode[] {
                    ...
                    new Opcode("astnul", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}, Action.Jump),
                    new Opcode("eqi32b", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("unk_60", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    Opcode.None(),
                    new Opcode("unk_62", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("unk_6a", new InstructionArg[] {InstructionArg.XRefV}),
                    new Opcode("unk_6b", new InstructionArg[] {InstructionArg.VSigned}),
                    Opcode.None(),
                    new Opcode("jmpcmp", new InstructionArg[] {InstructionArg.VSigned}, Action.Jump),
                    Opcode.None(),
