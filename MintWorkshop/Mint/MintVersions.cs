        ...
        public static Dictionary<byte[], Opcode[]> Versions = new Dictionary<byte[], Opcode[]>(new ByteArrayComparer())
        {
            ...
            },
            {
                ...
                new Opcode[] {
                    ...
                    new Opcode("fleave", new InstructionArg[] {InstructionArg.RegY}, Action.Return),
                    new Opcode("fretp",  new InstructionArg[] {InstructionArg.RegY}, Action.Return),
                    new Opcode("jmp",    new InstructionArg[] {InstructionArg.VSigned}, Action.Jump),
                    new Opcode("jmppos", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}, Action.Jump),
                    new Opcode("jmpneg", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.VSigned}, Action.Jump),
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("ldsrca",  new InstructionArg[] {InstructionArg.RegZ, InstructionArg.ArrV}, Action.None),
                    new Opcode("obnew", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.XRefV}, Action.None),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("opldv4", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opldvp", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opldva", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opstvp", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opstv4", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opstva", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("opstvb", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("op_58",  new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    new Opcode("op_59",  new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX}),
                    Opcode.None(),
                    new Opcode("unk_5b", new InstructionArg[] {InstructionArg.RegZ,InstructionArg.RegX,InstructionArg.RegY}),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    Opcode.None(),
                    ...
                    Opcode.None(),
                    new Opcode("unk_6f", new InstructionArg[] {InstructionArg.RegY}),
                    new Opcode("unk_70", new InstructionArg[] {InstructionArg.RegY}),
                    new Opcode("unk_71", new InstructionArg[] {InstructionArg.XRefV}),
                    new Opcode("yield",  new InstructionArg[] {InstructionArg.RegZ})
                }
            }
        };
