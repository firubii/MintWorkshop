        ...
        public static Dictionary<byte[], Opcode[]> Versions = new Dictionary<byte[], Opcode[]>(new ByteArrayComparer())
        {
            ...
            },
            {
                ...
                new Opcode[] {
                    ...
                    Opcode.None(),
                    Opcode.None(),
                    new Opcode("ldofa4", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("ldofap", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("ldofob", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("unk_54", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("stofa4", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("unk_56", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("unk_57", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("stofap", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
                    new Opcode("unk_59", new InstructionArg[] {InstructionArg.RegZ, InstructionArg.RegX, InstructionArg.XRefE}, Action.None, true),
